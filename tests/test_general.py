...
def main_test():
    ...
    Test if the complete example workflow runs through without errors.

    - downloads building and street data from openstreetmap,
    - runs lpagg to determine heat demand
    - prepares and runs dhnx to design a district heating network
    - simulate flow in the network with pandapipes
    """
    dhnx_addons.setup()
